export const fullStackProjects = [
  ...
  {
    title: 'Zodiac',
    description:"Zodiac is an online tshirt store which allows user to lookout tshirts, add them to cart and checkout. It also comprises of Admin dashboard for adding tshirts, setting price, deleting product and other stuffs.",
